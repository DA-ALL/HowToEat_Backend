...
public enum SuccessType {
    ...
    GET_USER_BASIC_INFO(HttpStatus.OK, "기본 유저정보 조회에 성공하였습니다."),
    ...
    UPDATE_PROFILE_IMAGE(HttpStatus.OK, "프로필 이미지 변경에 성공하였습니다."),
    ...
    // ======================= USER_MEAL_SCHEDULE =======================
    GET_USER_MEAL_SCHEDULE(HttpStatus.OK, "유저 식사 시간 조회에 성공하였습니다."),
